...
const MenuMatematika = () => {
  const navigation = useNavigation();

  return (
    <View style={[styles.menumatematika, styles.iconLayout]}>
      <LinearGradient
        style={styles.menumatematikaChild}
        locations={[0, 0.68]}
        colors={["rgba(15, 255, 255, 0.25)", "rgba(255, 255, 255, 0.25)"]}
      />
      <Text style={styles.matematika}>Matematika</Text>
      <View style={styles.frameParent}>
        <Pressable style={styles.wrapperLayout,styles.box}
        onPress={() => Linking.openURL('https://www.youtube.com/watch?v=zEq7opMWBuQ&list=PLKwoWAksYQ1KEwv2-GKeRvXfSgSW_DtJi&index=1&pp=iAQB')}>
        ...
        onPress={() => Linking.openURL('https://www.youtube.com/watch?v=gJa62jyATWs&list=PLKwoWAksYQ1KEwv2-GKeRvXfSgSW_DtJi&index=3&pp=iAQB')}>
